          ...
          >
            ...
            <div className="backdrop-blur-xl bg-white/10 rounded-3xl p-8 border border-white/20 shadow-2xl" style={{background: 'rgba(255, 255, 255, 0.1)'}}>
              <div className="max-w-lg">
                ...
                >
                  At Shree Durvankur Greens, our purpose is rooted in nurturing plants with care and responsibility. The nursery was created with a simple belief — healthy plants create healthier living spaces. Every plant grown here is carefully maintained to ensure strong growth, natural freshness, and long-term sustainability.
                </motion.p>
                ...
                >
                  <button 
                    ...
                    onClick={() => {
                      const storySection = document.getElementById('nursery-story');
                      if (storySection) {
                  ...
                  <button 
                    className="px-6 py-3.5 bg-transparent text-white font-semibold rounded-lg border border-white/50 hover:bg-white/10 transition-all duration-200 flex-1 text-center backdrop-blur-sm"
                    onClick={() => {
                      const learnMoreSection = document.getElementById('plant-types');
                      if (learnMoreSection) {
            ...
            <div className="relative">
              <div className="relative h-80 md:h-[480px] rounded-2xl overflow-hidden shadow-xl border border-white/20 backdrop-blur-sm">
                <Image
                  ...
                  alt="Shree Durvankur Greens Nursery"
                  fill
              ...
              >
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="text-xs font-medium text-white/80">Trusted</span>
                </div>
              ...
              >
                <div className="flex items-center gap-2 mb-1">
                  <span className="text-base">👨‍🌾</span>
                  <span className="text-xs font-medium text-white/80">Expert</span>
                </div>
                <div className="text-base font-semibold text-white">
                  Care
                </div>
              ...
              >
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="text-xs font-medium text-white/80">Local</span>
                </div>
                <div className="text-base font-semibold text-white">
                  Community
                </div>
